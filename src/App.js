...
export const App = () => {
  return (
    <div>
      <Section image>Top section: Mount header and into/sign-up div here.</Section>
      ...
      <Section white>Classes section</Section>
      <Section brown removeOnMobile>
        <TextBox
      ...
      <Section white>Find Us: mount location infobox here</Section>
      <Section blue halfWidth>Contact section</Section>
      <Section white halfWidth>Sign up section</Section>
      <Section brown>Footer section</Section>
    </div>
  )
}
