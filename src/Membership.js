...
const items = [
  { header: 'BE FLEXIBLE', access: 'PAY WHEN YOU PRACTICE', price: '2499 SEK/PER MONTH' },
  { header: 'BASIC', access: 'ACCESS ALL OUR IN-STUDIO CLASSES', price: '899 SEK/PER MONTH' },
  { header: 'GROW', access: 'ACCESS ALL OUR IN-STUDIO AND ONLINE CLASSES', price: '1899 SEK/PER MONTH' }
];
