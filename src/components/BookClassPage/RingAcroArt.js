...
import { AcroArtWrapper, RingAcrobat, /*  Acrostripe1, Acrostripe2, */Acrostripe3, Lines/* , Acrostripe4 */ } from './BookClassPageCSS';

export const RingAcroArt = () => {
  return (
    <AcroArtWrapper>
      <RingAcrobat src={`${RingAcrobatimg}`} />
      <Lines src={`${LinesIMG}`} alt="four lines displayed for decoration" />
