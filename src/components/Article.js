...
import articleImage1 from '../assets/Article1.png';
import articleImage2 from '../assets/Article2.png';
  ...
  return (
    <>
      <ArticleContainer1>
        ...
        <ImgBox>
          <Image src={articleImage1} alt="readme" />
        </ImgBox>
      </ArticleContainer1>
      ...
      <ArticleContainer2>
        ...
        <Button type="button">Read more</Button>
        <ImgBox>
          <Image src={articleImage2} alt="readme" />
        </ImgBox>
      </ArticleContainer2>
    </>
  )
