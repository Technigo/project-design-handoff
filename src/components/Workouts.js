...
import { Tagline, Headline1, Headline4, Headline5, Body } from 'styling/Text';
...
const Workouts = () => {
  return (
    <section className="sectionWorkouts">
      ...
      <div className="videoCard" style={{ backgroundImage: 'linear-gradient(5deg, #DCBAF9 10%, rgba(255, 255, 255, 0) 40%), url("../images/sidestretch.jpg")' }}>
