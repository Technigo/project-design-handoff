...
const Header = () => {
  return (
    <section className="header-section">
      ...
      <p className="body-copy">Choose between our <span>individual</span> sign-up and <span>Team sign-up</span> with exclusive access to our <span>Multiplayer Platform</span></p>
